...
namespace oopPracticalExam
{
    class Program
    {
        static void Main()
        {
            ...
            bank.addEmployee(new Employee("Shahd Samir", 29, "E003"));
            bank.addEmployee(new Employee("Mohamed Hasanin", 37, "E004"));
            bank.addEmployee(new Employee("Rwan Matter", 27, "E005"));
            ...
            bank.addCustomer(new Customer("Mayada Elhenawy", 70, "C006"));
